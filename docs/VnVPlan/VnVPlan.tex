...
\begin{enumerate}
  ...
  \item They will then look at the application as well to ensure that the implementation was made correctly
\end{enumerate}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item The developer will navigate to each of those functions, and note how many clicks were required to get there
  \end{enumerate}
  ...
  \begin{enumerate}
    ...
    \item They will verify that all pages and prompts are in the correct language
  \end{enumerate}
...
\begin{enumerate}
  ...
  Output/Result: List of all identified components that have data stored 

  How test will be performed:
  \begin{enumerate}
    \item A tester will enable logging in the components of the application
    \item They will do a run through of the different functionalities
    \item With each function, the tester will check logs and file systems and
    search for any type of data being stored
  \end{enumerate}
  ...
  Output/Result: Identified components that do not adhere to security requirements
  ...
  Output/Result: List of vulnerabilites and breach of regulations

  How test will be performed:
  \begin{enumerate}
    \item A tester will inspect the code repository and system application against laws and regulations
    \item All discrepancies between the law and the system will be identified, and updated promptly.
  \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
  ...
  How test will be performed:
  \begin{enumerate}
    \item Team members will regularly inspect the code and ensure all components follow software development standards
...
\begin{enumerate}
  ...
  How test will be performed:
  \begin{enumerate}
    \item A developer will review the documentation on the application. They must first ensure that documentation exists, and is easy to find
    \item They must then verify that the documentation is correct, and complete
    \item Anything missing or incorrect about the documentation will be brought up to the team immediately.
  \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Verify that an error message is displayed to the user and that the system doesn't crash or become unresponsive.
  \end{enumerate}
\end{enumerate}
