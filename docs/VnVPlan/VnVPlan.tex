...
Initial State: system is active, spot for uploading code snippet into
system is open with zero or more existing snippets currently loaded.
...
receiving code and receive files in varying amounts, one batch at a time, all the 
while being inspected for failure in this process (types: dynamic, functional).
...
Initial State: system is active, 2 or more code snippets have been uploaded, and 
