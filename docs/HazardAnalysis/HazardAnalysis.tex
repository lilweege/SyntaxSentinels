...
\begin{enumerate}
    ...
    \begin{itemize}
        \item The team was able to identify potential risks and hazards that could affect the system. It was a good exercise to think about the 
        system from a different perspective. Also due to time constraints, the deliverable was shortened and we were able to focus on the most 
        important rather than scrambling to include everything.
    \end{itemize}
    \item What pain points did you experience during this deliverable, and how
    did you resolve them?
    \begin{itemize}
        \item The team had difficulty with time contraints due to other deliverables and exams. This was resolved by other team members taking on
        more work to ensure the deliverable was completed on time.
    \end{itemize}
    ...
    did they come about?
    \begin{itemize}
        \item The team had thought of the risks associated with the model being overfitted and providing false positives. However, the team had not
        thought of the risks associated with the model tokenizing comments incorrectly. This came about while thinking of the different ways
        users could bypass the plagiarism detection system.
    \end{itemize}
