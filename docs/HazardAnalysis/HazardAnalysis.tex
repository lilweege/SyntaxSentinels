...
\hspace*{-3cm}\includegraphics[height=.58\textheight]{./assets/Component_Border.png}

Diagram shows referential relationships, not workflows. System Boundary
shows compnents our team will maintain and be responsible for (not including 
machines that are self-hosted).
