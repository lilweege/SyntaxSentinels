...
\begin{itemize}
    \item \textbf{SR-SAF1: Submission Rate Limitation}
    \begin{itemize}
    ...
    \item \textbf{SR-SAF2: Safe System States During Failure}
    \begin{itemize}
    ...
    \item \textbf{SR-SAF4: Protection Against Inappropriate Inputs}
    \begin{itemize}
    ...
    \item \textbf{SR-SAF5: Isolation of Critical Functions}
    \begin{itemize}
...
\begin{itemize}
    \item \textbf{SR-SAF3: Warning of Potentially Inaccurate Detections}
    \begin{itemize}
