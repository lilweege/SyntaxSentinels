...
SyntaxSentials will be using a \href{https://github.com/lilweege/SyntaxSentinels?tab=License-1-ov-file#}{MIT license}

\section{Team Meeting Plan}

The team will meet for at least 4 hours every week, 2 hours during the allotted tutorial time on Monday at 2:30 pm. Precise location will be open
but the meeting will be virtually, otherwise on McMaster University campus. the other 2 hours allotted would be done virtually over the weekend.
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Write a clear, detailed description to ensure the team fully understands what needs to be done without needing additional questions or clarification.
        \item At this stage, the team can discuss what needs to be done, identify the problem, and determine the best course of action.
    \end{itemize}
