...
\begin{itemize}
    ...
    \item Detected plagiarism must be recorded for future use such as appeals.
    \item Detected plagiarism must be stored in our database for future use such as appeals.
\end{itemize}
...
- Not knowing how to use the new UI
- Incorrect interpretation / poor understanding of result signifigance
...
- Upgrading or training new models might cause performance regressions
