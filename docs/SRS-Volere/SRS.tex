...
\begin{center}
    ...
    \hline
    Online Learning & Provide ability for user to train model on their own datasets. & 
...
\begin{enumerate}
    ...
    \item The system compares the parsed code against other uplaoded submissions and datasets using the plagiarism detection model.
...
\begin{itemize}
    \item The system shall take in code snippets as inputs
    \item The system shall output similarity scores alongside thresholds 
    that indicate whether or not plagiarism is present within input
    \item The system shall be able to output documentation explaining
    how to interpret any other output (guide document)
    \item The system shall allow code snippets to be flagged after similarity
    scores and thresholds are generated
    \item The system shall provide a set of similarity scores for all code 
    snippet pairings
    \item The system shall allow a report to be created after scores and 
    thresholds are generated that summarizes all system outputs 
    \item The system will allow users to create an account with an email 
    and password
    \item The system will allow users to sign into a created account with 
    their email and password
    \item The system shall be able to email all outputs as a .zip folder 
    to an email selected by user
    \item System shall be able to visualize .zip folder containing its outputs
    uploaded by user on user interface
\end{itemize}
...
\begin{enumerate}
  ...
  \textbf{Knowledge Areas:}
    \begin{itemize}
        ...
        requests for analyzing plagariasm from a non-local user. Necessary to be able to host our model outside of a local host.
    \end{itemize}
    \textbf{Skills:}
    \begin{itemize}
        \item \textbf{Writing}: The ability to convey thoughts in a formalized manner. Necessary to write documentation for project such as SRS.
        \item \textbf{Team Management}: The ability to delegate responsibilities amongst members in a respectful manner while working off feedback of teammates about their enjoyment of given tasks to retain a cohesive team dynamic. Necessary to keep work on track and also maintain an enthusiastic team spirit.
        \item \textbf{Proactive Communication}: Letting others know in advance the direction you want to head in for a given task. Necessary for allowing strong planning that will not crumble under roadblocks in code development, which are bound to happen.
    \end{itemize}
  ...
  member pursue, and why did they make this choice?
    \begin{itemize}
        \item \textbf{Server Deployment}: Youtube Videos, Online Articles, Building it
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Team Management}: Lucas will pursue learning more about GitHub project management tools and techniques. This is because he has taken on the role as project manager and needs to understand how to manage the team effectively.
        \end{itemize}
        \item \textbf{Dennis Fong:}
        \begin{itemize}
            \item \textbf{NLP Techniques}: Dennis will look for research papers on NLP, especially ones that pertain to the topic of this project. This is because he seeks a deeper understanding of the inner workings of how a model works
            \item \textbf{Team Management}: Dennis will learn about team management through the usage of Github, and the many features it supports for managing a project for the team. He is not as familiar with Github as his team members, and this will serve as a strong learning experience.
        \end{itemize}

        \item \textbf{Julian Cecchini:} 
        \begin{itemize}
            \item \textbf{Server Deployment}: Julian will pursue online articles to learn this. He finds maintaining attention for long youtube videos can be cumbersome and if he's interrupted, it's easier to pick up off online articles than youtube videos.

            \item \textbf{Proactive Communication}: Julian will schedule meetings for direction. He feels the commitment imposed by a meeting where he must announce his thoughts will have him try more consistently to announce his direction than a notebook reminder that suggests he should bring some thoughts forward.
        \end{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Writing}: Luigi will pursue improvement in writing by continuing to write documentation and enforcing strict linter rules about comments and function docstrings in the project source code. This will help him to improve his own communication with his team and to improve documentation for any other maintainers of the project.
        \end{itemize}
    \end{itemize}
\end{enumerate}
