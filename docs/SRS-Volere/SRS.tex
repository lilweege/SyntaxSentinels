...
\begin{table}[htbp]
    ...
    2 & Process Code for Plagiarism Detection & System, Professor & Uploaded Code (in) / Processed Code (out) \\ \hline
    3 & Generate Similarity Scores & System & Processed Code (in) / Similarity Scores (out) \\ \hline
    ...
    \end{tabular}
    \caption{Product Use Case (PUC) Summary Table}
\end{table}
