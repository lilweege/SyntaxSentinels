...
\textbf{status}: Represents the status of a user's account.
\begin{itemize}
    \item \textbf{Values}:
    \begin{itemize}
        \item \texttt{Active}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \texttt{languageType: language} -- The programming language used, selected from the \texttt{language} enumeration.
...
\begin{itemize}
    \item \textbf{Attributes}:
    \begin{itemize}
        \item \texttt{parsedStructure: Token[]} -- An array of tokens that represents the parsed structure of the code. Note: the actual structure of tokens is still to be determined.
    \end{itemize}
    \item \textbf{Relationships}:
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \texttt{accountStatus: status} -- The status of the user's account, selected from the \texttt{status} enum.
    \end{itemize}
    \item \textbf{Relationships}:
    \begin{itemize}
        \item A \texttt{User} can submit multiple \texttt{CodeSnippet} objects (1-to-many relationship).
