...
\begin{enumerate}
    \item \textbf{Software Development Standards}: While full adherence to comprehensive standards 
    such as ISO/IEC 25010 may be beyond the scope of this student capstone project, we aim to follow 
    recognized software development practices to ensure quality and reliability.
        \begin{itemize}
            \item \textbf{Focus on Key Quality Attributes}: The project will prioritize key aspects of 
            software quality, including functionality, reliability, usability, efficiency, and maintainability,
             drawing inspiration from the ISO/IEC 25010 framework.
